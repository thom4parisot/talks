...
module.exports = {
  ...
  permalink: function getTalkPermalink(talk){
    return talk.external || talk.filename;
  },

  cols: function getColWidth(total_length, current_index){
    var treshold = (3 * Math.floor(total_length / 3));


    return (current_index + 1 > treshold) ? 12 / (total_length - treshold) : 4;
  },
